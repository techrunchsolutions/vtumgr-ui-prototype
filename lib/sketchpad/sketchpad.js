  ...
  getKeycodeStr: function (keyCode) {
    ...
    switch (keyCode) {
      case 32:
        ...
        break;
      case 91:
        chr = this.isMac() ? "âŒ˜" : "WIN"; //cmd
        break;
      case 18:
        chr = this.isMac() ? "âŒ¥" : "ALT"; //alt
        break;
      case 16:
        chr = this.isMac() ? "â‡ª" : "SHIFT"; //shift
        break;
      case 17:
      ...
      case 27:
        ...
        break;
      case 20:
        chr = this.isMac() ? "â‡ª" : "Caps lock"; //capslock
        break;
      case 13:
        chr = "âŽ"; //enter
        break;
